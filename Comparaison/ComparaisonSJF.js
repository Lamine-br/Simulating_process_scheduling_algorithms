  ...
  DetruireProcessus(temps) {
      ...
      this.#dispatcher.setSignal(true);
        ...
        Ordonnanceur_SJF1() { /* ACTIF */
            ...
            num_file = 0;
            /*--------------------------------------------------------------------------------*/
            var TableauSJF1 = new Array(i);
            for(var i1=0; i1<TableauSJF1.length;i1++)
            {
              TableauSJF1[i1]= [];
            }
            /*--------------------------------------------------------------------------------*/
            while (j !== i) {
              ...
              if (this.#dispatcher.getSignal() === true) {
                ...
                if (this.#files.getFile(0).getFile().length !== 0) {
                  ...
                  this.#dispatcher.IncrementerNb();
                  /*----------------------------------------------------------------------*/
                  TableauSJF1[this.#processeur.getProcessus().getPCB().getPID()-1].push(t);
                  /*----------------------------------------------------------------------*/
                  console.log(
                    "t = " +
                      t +
              ...
              if (!arret) {
                for (let j = 0; j < this.#fileBloquee.getFile().length; j++) {
                  if (
                    ...
                    /*----------------------------------------------------------------------*/
                    TableauSJF1[this.#fileBloquee.getFile()[j].getPCB().getPID()-1].push(t);
                    /*----------------------------------------------------------------------*/
                    TableauSJF1[this.#fileBloquee.getFile()[j].getPCB().getPID()-1].push(t);
                    /*----------------------------------------------------------------------*/
                    console.log(
        ...
        Ordonnanceur_SJF2() { /* BLOQUE */
          ...
          num_file = 0;
          /*--------------------------------------------------------------------------------*/
          var TableauSJF2 = new Array(i);
          for(var i1=0; i1<TableauSJF2.length;i1++)
          {
            TableauSJF2[i1]= [];
          }
          /*--------------------------------------------------------------------------------*/
                ...
                if (this.#processeur.getProcessus().getTempsRestant() === 0) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      this.#processeur.getProcessus().setPriorite(num_file);
                       /*----------------------------------------------------------------------*/
                        TableauSJF2[this.#processeur.getProcessus().getPCB().getPID()-1].push(t);
                      /*----------------------------------------------------------------------*/
                      console.log(
                        "t = " +
                          t +
            ...
            if (!arret) {
              for (let j = 0; j < this.#fileBloquee.getFile().length; j++) {
                if (
                  ...
                  /*----------------------------------------------------------------------*/
                  TableauSJF2[this.#fileBloquee.getFile()[j].getPCB().getPID()-1].push(t);
                  /*----------------------------------------------------------------------*/
                  console.log(
                    "t = " +
                      t +
        ...
        Ordonnanceur_SJF3() {
          ...
          num_file = 0;
          /*--------------------------------------------------------------------------------*/
          var TableauSJF3 = new Array(i);
          for(var i1=0; i1<TableauSJF3.length;i1++)
          {
            TableauSJF3[i1]= [];
          }
          /*--------------------------------------------------------------------------------*/
          while (j !== i) {
            ...
            while (h < this.#processus.length) {
              if (this.#processus[h].getTempsArrive() === t) {
                /*----------------------------------------------------------------------*/
                TableauSJF3[this.#processus[h].getPCB().getPID()-1].push(t);
                /*----------------------------------------------------------------------*/
                console.log(
                  "t = " +
                    t +
            ...
            if (this.#dispatcher.getSignal() === true) {
              ...
              if (this.#files.getFile(0).getFile().length !== 0) {
                ...
                this.#dispatcher.IncrementerNb();
                /*----------------------------------------------------------------------*/
                TableauSJF3[this.#processeur.getProcessus().getPCB().getPID()-1].push(t);
                /*----------------------------------------------------------------------*/
                console.log(
                  "t = " +
                    t +
            ...
            if (!arret) {
              for (let j = 0; j < this.#fileBloquee.getFile().length; j++) {
                if (
                  ...
                  /*----------------------------------------------------------------------*/
                TableauSJF3[this.#fileBloquee.getFile()[j].getPCB().getPID()-1].push(t);
                /*----------------------------------------------------------------------*/
                  console.log(
                    "t = " +
                      t +
...
Init1(scheduler1) ;
var TableSJF1 = new Array(scheduler1.getProcessus().length);
TableSJF1 = scheduler1.Ordonnanceur_SJF1();
...
Init1(scheduler2) ;
var TableSJF2 = new Array(scheduler2.getProcessus().length);
TableSJF2 = scheduler2.Ordonnanceur_SJF2();
...
Init1(scheduler3) ;
var TableSJF3 = new Array(scheduler3.getProcessus().length);
TableSJF3 = scheduler3.Ordonnanceur_SJF3();
...
/*--------------------------------------------------------------*/
      ...
      function drawChart() {;
        ...
        var elm=0;
        for(var i=0; i<TableSJF1.length; i++){
        elm=0;
            for(var j=0;j<TableSJF1[i].length / 2; j++)
            {
                dataTable.addRows([
                    [
                      "P" + (i+1),
                      "Processus Actif",
                      getDate(TableSJF1[i][j+elm]),
                      getDate(TableSJF1[i][j+elm+1]),
                    ]
                ]);
                elm = elm +1;
            }
          }
          for(var i=0; i<TableSJF2.length; i++){
            elm=0;
                for(var j=0;j<TableSJF2[i].length / 2; j++)
                {
                    dataTable.addRows([
                        [
                          "P" + (i+1),
                          "Processus Bloque",
                          getDate(TableSJF2[i][j+elm]),
                          getDate(TableSJF2[i][j+elm+1]),
                        ]
                    ]);
                    elm = elm +1;
                }
              }
              for(var i=0; i<TableSJF3.length; i++){
                elm=0;
                    for(var j=0;j<TableSJF3[i].length / 2; j++)
                    {
                        dataTable.addRows([
                            [
                              "P" + (i+1),
                              "Processus Pret",
                              getDate(TableSJF3[i][j+elm]),
                              getDate(TableSJF3[i][j+elm+1]),
                            ]
                        ]);
                        elm = elm +1;
                    }
