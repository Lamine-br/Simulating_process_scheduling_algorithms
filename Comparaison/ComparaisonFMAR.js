...
class Scheduler {
  ...
  /*****************Ordonnanceur Files Multiniveaux Avec Recyclage (1)*****************/
  Ordonnanceur_FMAR1() { /* ACTIVER */
    let i = this.#processus.length,
      ...
      num_file = 0;
    /*--------------------------------------------------------------------------------*/
    var TableauFMAR1 = new Array(i);
    for (var i1 = 0; i1 < TableauFMAR1.length; i1++) {
      TableauFMAR1[i1] = [];
    }
    ...
    while (j !== i) {
      ...
      if (this.#dispatcher.getSignal() === true) {
        ...
        if (num_file !== -1) {
          ...
          this.#dispatcher.IncrementerNb();
          /*----------------------------------------------------------------------*/
          TableauFMAR1[this.#processeur.getProcessus().getPCB().getPID() - 1].push(t);
          /*----------------------------------------------------------------------*/
          console.log(
            "t = " +
            t +
      ...
      if (!arret) {
        for (let j = 0; j < this.#fileBloquee.getFile().length; j++) {
          if (
            ...
            /*----------------------------------------------------------------------*/
            TableauFMAR1[this.#fileBloquee.getFile()[j].getPCB().getPID()- 1].push(t);
            /*----------------------------------------------------------------------*/
            TableauFMAR1[this.#fileBloquee.getFile()[j].getPCB().getPID() - 1].push(t);
            /*----------------------------------------------------------------------*/
            console.log(
  ...
  Ordonnanceur_FMAR2() { /* BLOQUER */
    let i = this.#processus.length,
      ...
      num_file = 0;
    /*--------------------------------------------------------------------------------*/
    var TableauFMAR2 = new Array(i);
    for (var i1 = 0; i1 < TableauFMAR2.length; i1++) {
      TableauFMAR2[i1] = [];
    }
    var i2 = 0; var i3 = 0; var i4 = 0; var i5 = 0;
    /*--------------------------------------------------------------------------------*/
            ...
            if (cpt === quantum) {
              ...
              if (
                ...
                if (
                  ...
                  this.#processeur.getProcessus().setPriorite(num_file);
                  /*----------------------------------------------------------------------*/
                  TableauFMAR2[this.#processeur.getProcessus().getPCB().getPID() - 1].push(t);
                  /*----------------------------------------------------------------------*/
                  console.log(
                    "t = " +
                    t +
      ...
      if (!arret) {
        for (let j = 0; j < this.#fileBloquee.getFile().length; j++) {
          if (
            ...
            /*----------------------------------------------------------------------*/
            TableauFMAR2[this.#fileBloquee.getFile()[j].getPCB().getPID() - 1].push(t);
            /*----------------------------------------------------------------------*/
            console.log(
              "t = " +
              t +
  ...
  /*****************Ordonnanceur Files Multiniveaux Avec Recyclage (3)*****************/
  Ordonnanceur_FMAR3() { /* PRET */
    let i = this.#processus.length,
      j = 0,
      t = 0,
      h = 0,
      ...
      num_file = 0;
    /*--------------------------------------------------------------------------------*/
    var TableauFMAR3 = new Array(i);
    for (var i1 = 0; i1 < TableauFMAR3.length; i1++) {
      TableauFMAR3[i1] = [];
    }
    var i2 = 0; var i3 = 0; var i4 = 0; var i5 = 0;
    /*--------------------------------------------------------------------------------*/
    while (j !== i) {
      ...
      while (h < this.#processus.length) {
        if (this.#processus[h].getTempsArrive() === t) {
          /*----------------------------------------------------------------------*/
          TableauFMAR3[this.#processus[h].getPCB().getPID() - 1].push(t);
          /*----------------------------------------------------------------------*/
          console.log(
            "t = " +
            t +
      ...
      if (this.#dispatcher.getSignal() === true) {
        ...
        if (num_file !== -1) {
          ...
          this.#dispatcher.IncrementerNb();
          /*----------------------------------------------------------------------*/
          TableauFMAR3[this.#processeur.getProcessus().getPCB().getPID() - 1].push(t);
          /*----------------------------------------------------------------------*/
          console.log(
            "t = " +
            t +
      ...
      if (!arret) {
        for (let j = 0; j < this.#fileBloquee.getFile().length; j++) {
          if (
            ...
            /*----------------------------------------------------------------------*/
            TableauFMAR3[this.#fileBloquee.getFile()[j].getPCB().getPID() - 1].push(t);
            /*----------------------------------------------------------------------*/
            console.log(
              "t = " +
              t +
...
Init1(scheduler1);
var TableFMAR1 = new Array(scheduler1.getProcessus().length);
TableFMAR1 = scheduler1.Ordonnanceur_FMAR1();
...
Init1(scheduler2);
var TableFMAR2 = new Array(scheduler2.getProcessus().length);
TableFMAR2 = scheduler2.Ordonnanceur_FMAR2();
...
Init1(scheduler3);
var TableFMAR3 = new Array(scheduler3.getProcessus().length);
TableFMAR3 = scheduler3.Ordonnanceur_FMAR3();
...
function drawChart() {
  ;
  var container = document.getElementById("FMAR");
  ...
  var elm = 0;
  for (var i = 0; i < TableFMAR1.length; i++) {
    elm = 0;
    for (var j = 0; j < TableFMAR1[i].length / 2; j++) {
      dataTable.addRows([
        [
          "P" + (i + 1),
          "Processus Actif",
          getDate(TableFMAR1[i][j + elm]),
          getDate(TableFMAR1[i][j + elm + 1]),
        ]
      ]);
      elm = elm + 1;
    }
  }
  for (var i = 0; i < TableFMAR2.length; i++) {
    elm = 0;
    for (var j = 0; j < TableFMAR2[i].length / 2; j++) {
      dataTable.addRows([
        [
          "P" + (i + 1),
          "Processus Bloque",
          getDate(TableFMAR2[i][j + elm]),
          getDate(TableFMAR2[i][j + elm + 1]),
        ]
      ]);
      elm = elm + 1;
    }
  }
  for (var i = 0; i < TableFMAR3.length; i++) {
    elm = 0;
    for (var j = 0; j < TableFMAR3[i].length / 2; j++) {
      dataTable.addRows([
        [
          "P" + (i + 1),
          "Processus Pret",
          getDate(TableFMAR3[i][j + elm]),
          getDate(TableFMAR3[i][j + elm + 1]),
        ]
      ]);
      elm = elm + 1;
    }
