...
class Scheduler {
    ...
    ActiverProcessus(num_file , temps) {
        ...
        console.log("doone : " + process.getPCB().getPID());
...
function Ordonnanceur_SJF_NonPreemptif() {
    stop = false ;
    let tr = document.getElementsByClassName('pro') ;
        anime({
            targets : tr ,
...
inp.addEventListener('input' , function(e){
    var temps1 = parseInt(document.querySelector('select').value , 10) ;
    console.log(temps1) ;
...
function detruire_interruption(){
